...
<section class="content-wrapper" role="main" data-init-content="true">
      <div class="content">
          ...
          <div class="content-hero-body">
            <!-- /.content-bar -->
            <h1 style="color: white;">VEHICULOS EXCEPTUADOS</h1>
          ...
          <div class="content-body">
            <div class="panel" data-fill-color="true">
              <div class="panel-heading">
                ...
                <h3 class="panel-title">Vehiculos exceptuados</h3>
              </div><!-- /.panel-heading -->
              ...
              <div class="panel-body hide" id="addFormContainer">
                <form id="formAddDatatables1" action="#" method="POST">
                  <div class="form-group">
                    <p class="lead">Agregar vehiculo exceptuado</p>
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <div class="input-group input-group-in">
                          ...
                          <input name="createZone" id="createZone" class="form-control input-sm" autocomplete="off" placeholder="Zona (si corresponde)">
                          <span class="input-group-btn">
                            <a rel="tooltip" data-container="body" title="Marcar en mapa" onclick="markSpecialVehiclesZoneInMap('create');" class="btn">
              ...
              <div class="panel-body hide" id="editFormContainer">
                <form id="formEditDatatables1" action="#" method="POST">
                  ...
                  <input type="hidden" name="exceptuatedId" id="exceptuatedId">
                  <div class="form-group">
                    <p class="lead">Editar vehiculo exceptuado</p>
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="select select-sm">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <input name="editStart" type="datetime-local" id="editStart" class="form-control input-sm" placeholder="" autocomplete="off" required="">
                        </div>
                      </div><!-- /.cols -->
                      <div class="col-md-3">
                        <div class="form-group">
                          <input name="editEnd" type="datetime-local" id="editEnd" class="form-control input-sm" placeholder="" autocomplete="off" required="">
                        </div>
                      </div><!-- /.cols -->
                      <div class="col-md-2">
                        <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <div class="input-group input-group-in">
                          <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                          <input name="editZone" id="editZone" class="form-control input-sm" autocomplete="off" placeholder="Zona (si corresponde)">
                          <span class="input-group-btn">
                            <a rel="tooltip" data-container="body" title="Marcar en mapa" onclick="markSpecialVehiclesZoneInMap('edit');" class="btn">
                              <i class="fa fa-map-pin" aria-hidden="true"></i>
                            </a>
                          </span>
                        </div><!-- /input-group-in -->
...
<!-- COMPONENTS -->
  ...
  <script src="scripts/sems/adm-datatables-exceptuated.js"></script>
  <link rel="stylesheet" href="styles/leaflet.css">
  <script src="scripts/sems/leaflet.js"></script>
  <script src="scripts/sems/adm-special-vehicles-maps.js"></script>
@endpush
