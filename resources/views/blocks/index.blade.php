    ...
    <div class="content">
        <div id="content-hero" class="content-hero">
            ...
            <div class="content-hero-body">
                <!-- /.content-bar -->
                <h1 style="color: white;">CALLES</h1>
            </div>
            <!-- /.content-hero-body -->
        </div>
        ...
        <div class="content-body">
            <div class="panel" data-fill-color="true">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Calles</h3>
                </div>
                <!-- /.panel-heading -->
                    ...
                    <form id="formAddDatatables1" action="#" method="POST">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input name="createSize" id="createSize" type="number" class="form-control input-sm" placeholder="Lugares" autocomplete="off" required="">
                                    </div>
                                </div>
                                <!-- /.cols -->
                                <div class="col-md-3">
                                    <div class="input-group input-group-in">
                                        ...
                                        <span class="input-group-btn">
                                            <a rel="tooltip" data-container="body" title="Marcar en mapa" onclick="markBlockZoneInMap('create');" class="btn">
                    ...
                    <form id="formEditDatatables1" action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input name="editMaxNum" id="editMaxNum" type="number" class="form-control input-sm" placeholder="Número máximo" autocomplete="off" required="">
                                    </div>
                                </div>
                                <!-- /.cols -->
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input name="editMinNum" id="editMinNum" type="number" class="form-control input-sm" placeholder="Número mínimo" autocomplete="off" required="">
                                    </div>
                                </div>
                                <!-- /.cols -->
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input name="editSize" id="editSize" type="number" class="form-control input-sm" placeholder="Lugares" autocomplete="off" required="">
                                    </div>
                                </div>
                                <!-- /.cols -->
                                <div class="col-md-2">
                                    <div class="input-group input-group-in">
                                        ...
                                        <input name="editZone" type="text" id="editZone" class="form-control input-sm" autocomplete="off" placeholder="Marcar calle" required="">
                                        <span class="input-group-btn">
                                            <a rel="tooltip" data-container="body" title="Marcar en mapa" onclick="markBlockZoneInMap('edit');" class="btn">
                                                <i class="fa fa-map-pin" aria-hidden="true"></i>
                                            </a>
                                        </span>
                                    </div>
...
@push('scripts')
  ...
  <script src="scripts/sems/adm-datatables-blocks.js"></script>
  <link rel="stylesheet" href="styles/leaflet.css">
  <script src="scripts/sems/leaflet.js"></script>
  <script src="scripts/sems/adm-blocks-maps.js"></script>
@endpush
