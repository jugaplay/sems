        ...
        <div class="pull-right" role="navigation">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right" role="menu" style="opacity: 0; display: none; transform: scaleX(1) scaleY(1) translateY(0px); transform-origin: 50% 50% 0px;">
              ...
              <li role="presentation" class="" style="opacity: 1; display: list-item; transform: translateY(0px);"><a role="menuitem" tabindex="-1" href="{{ route('credit.self') }}"><span class="pull-right"><i class="fa fa-usd text-muted"></i></span>Saldo</a></li>
