                        ...
                        <div class="float-bar clearfix">
                            <div class="float-bar-brand">
                                <a class="kit-avatar kit-avatar-128 no-padding border-white" href="#">
                                    <img alt="cover" src="images/dummy/uifaces17.jpg">
                                </a>
                            </div>
                            <div class="col-sm-8">
                                <div class="visible-xs">
                                    <h2 class="display-name media-heading text-teal">Juan Carlos</h2>
                                    <p class="text-muted mb-4x">
                                        <i class="fa fa-map-marker fa-fw"></i> Gps encendido</span>
                                    </p>
                                </div>
                                <div class="hidden-xs">
                                    <h2 class="media-heading text-light">Juan Carlos</h2>
                                ...
                                <div class="mt-4x">
                                    <p>
                                        <i class="fa fa-user" aria-hidden="true"></i> Asistente</p>
                                    <p>
