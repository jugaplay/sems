    ...
    <div class="content">
                        ...
                        <div class="float-bar clearfix">
                            <div class="float-bar-brand">
                                <a class="kit-avatar kit-avatar-128 no-padding border-white" href="#">
                                    <img alt="cover" src="images/dummy/uifaces18.jpg">
                                </a>
                            </div>
                            <div class="col-sm-8">
        ...
        <div class="content-body">
            <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">Chequear</h3>
                                        <p class="help-block">Chequear estacionamientos</p>
                                    </div>
                                    <!-- /.media -body-->
                                </div>
                                <!-- /.media -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <a href="infractions.html" style="color: inherit;">
                        <div class="panel fade in panel-default" data-init-panel="true">
                            <div class="panel-body">
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">Infracciones</h3>
                                        <p class="help-block">Generar infracciones</p>
                                    </div>
                                    <!-- /.media -body-->
                                </div>
                                <!-- /.media -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <a href="containers.html" style="color: inherit;">
                        <div class="panel fade in panel-default" data-init-panel="true">
                            <div class="panel-body">
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">Especiales</h3>
                                        <p class="help-block">Contenedores y carga/descarga</p>
                                    </div>
                                    <!-- /.media -body-->
                                </div>
                                <!-- /.media -->
