        ...
        <div class="content-body">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 col-xs-12">
                            ...
                            <form role="form" id="ticketFormContainer">
                                <div class="form-group form-group-lg">
                                    ...
                                    <div class="input-group input-group-in">
                                        ...
                                        <input type="text" class="form-control input-lg" onkeydown="upperCaseF(this)" name="ticketPlate" id="ticketPlate" placeholder="Patente" required="">
                                    </div>
                                    <!-- /input-group-in -->
                                </div>
                                <!--/form-group-->
                                ...
                                <div class="form-group form-group-lg">
                                    ...
                                    <select class="form-control" name="ticketPayment" id="ticketPayment">
                                        <option value="EF">Credito</option>
                                        <option value="ON">Pago Online</option>
                                    </select>
                                </div>
                                <!--/form-group-->
                                <!--/form-group-->
                                <div class="form-group form-group-lg">
                                    <input type="hidden" value="{{$block_id}}" name="blockId" id="blockId">
                                    {{csrf_field()}}
                    ...
                    <input type="hidden" id="owned-cars" value="{{ $ownedCars}}" />
