(function(){
  ...
  var datatables1 = $( '#datatables1' ).dataTable({
    ...
    'sAjaxSource': '../_includes/data-adm-specialplaces-source.json', // Aca van los datos y los carga con Ajax?!
    'fnInitComplete': function(settings) {
      ...
      $.each( aoData, function(i, val){
        ...
        $ntr.attr( 'data-longitud', val._aData[9]);
        $ntr.attr( 'data-latitud', val._aData[10]);
      });
  ...
  .on( 'submit', '#formAddDatatables1', function(e){
    ...
    datatables1.$( 'tr.active' ).removeClass( 'active' );
    $( newRow ).attr( 'data-specialid', '1');// Devuelve el special id
  ...
  .on( 'submit', '#formEditDatatables1', function(e){
    ...
    dataUpdate = [ "Calle server", datas[2].value, datas[3].value, datas[4].value, datas[5].value, datas[6].value, datas[7].value, datas[8].value];

    dataSelected.data( 'id', datas[0].value );
    dataSelected.data( 'specialid', datas[1].value);

    dataSelected.data( 'latitud', datas[9].value);
    dataSelected.data( 'longitud', datas[10].value);
