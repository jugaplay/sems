(function(){
  ...
  var datatables1 = $( '#datatables1' ).dataTable({
    ...
    'sAjaxSource': '../_includes/data-adm-specialvehicles-source.json', // Aca van los datos y los carga con Ajax?!
  ...
  .on( 'submit', '#formAddDatatables1', function(e){
    ...
    datatables1.$( 'tr.active' ).removeClass( 'active' );
    $( newRow ).attr( 'data-exceptuatedid', '1');// Agrega el Id que devuelve
  ...
  .on( 'submit', '#formEditDatatables1', function(e){
    ...
    dataSelected.data( 'zone', datas[7].value);
    dataSelected.data( 'detail', datas[8].value);
