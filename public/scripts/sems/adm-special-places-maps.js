...
function pulseMarkerOnMap(lat,lon){
		...
		if(window.marker!=null){
			...
			map.addLayer(marker);
			marker.bindPopup("<b>Espacio reservado</b><br/>Añade el lugar al mapa, arrastrar hasta el punto exacto.").openPopup();
		}
}
