(function(){
  ...
  var datatables1 = $( '#datatables1' ).dataTable({
    ...
    'sAjaxSource': 'users/all', // Aca van los datos y los carga con Ajax?!
    'fnInitComplete': function(settings) {
      ...
      $.each( aoData, function(i, val){
        ...
        $ntr.attr( 'data-userid', val._aData[5]);
      });
  ...
  .on( 'submit', '#formAddDatatables1', function(e){
    ...
    var jqxhr = $.ajax({
                  ...
                  .done(function(xhr) {
                    toastr.success( 'Usuario <b>' + xhr.name + '</b> agregado exitosamente!' );
  ...
  .on( 'submit', '#formEditDatatables1', function(e){
    ...
    var jqxhr = $.ajax({
                    method: "PUT",
                    url: window.apiUrl+"users/"+datas[1].value,
                    data: datas
                  })
                  .done(function(xhr) {
                    toastr.success( 'Usuario <b>' + xhr.name + '</b> actualizado exitosamente!' );
  ...
  getDataSelected = function(){
    ...
    phone = dataSelected.children( 'td:eq(2)' ).text(),
    accountType = dataSelected.children( 'td:eq(3)' ).text(),
